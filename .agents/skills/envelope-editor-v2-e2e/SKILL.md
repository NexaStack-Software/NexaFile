...
npm run test:dev -w @nexasign/app-tests -- --grep "Envelope Editor V2"

# Run a specific test file
npm run test:dev -w @nexasign/app-tests -- e2e/envelope-editor-v2/envelope-recipients.spec.ts

# Run with UI
npm run test-ui:dev -w @nexasign/app-tests -- e2e/envelope-editor-v2/

# Run specific test by name
npm run test:dev -w @nexasign/app-tests -- --grep "documents/<id>: add myself"
```
