...
```
docker run -d --restart=unless-stopped -p 3000:3000 -v nexasign:/app/data --name nexasign nexasign:latest
```
...
- `nexasign:latest` - Image you have built
...
[![Deploy to Render](https://render.com/images/deploy-to-render-button.svg)](https://render.com/deploy?repo=https://github.com/nexasign/nexasign)
