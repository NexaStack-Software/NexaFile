...
if [ -f "$CERT_PATH" ] && [ -r "$CERT_PATH" ]; then
    ...
    printf "   Fix for production: buy an AATL cert — see SIGNING.nexafile.md\n"
fi

printf "\n📚 Useful Links:\n"
printf "📖 NexaFile README:          README.nexafile.md (repo root)\n"
printf "🔐 Certificate setup:        SIGNING.nexafile.md\n"
printf "📋 Changelog vs. Upstream:   CHANGELOG.nexafile.md\n"
