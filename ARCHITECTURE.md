...
| Package              | Description                                               |
| -------------------- | --------------------------------------------------------- |
| `@nexasign/lib`     | Core business logic (server-only, client-only, universal) |
| `@nexasign/trpc`    | tRPC API layer with OpenAPI support (API V2)              |
| `@nexasign/api`     | REST API layer using ts-rest (API V1)                     |
| `@nexasign/prisma`  | Database layer (Prisma ORM + Kysely)                      |
| `@nexasign/ui`      | UI component library (Shadcn + Radix + Tailwind)          |
| `@nexasign/email`   | Email templates and mailer (React Email)                  |
| `@nexasign/auth`    | Authentication (OAuth via Arctic, WebAuthn/Passkeys)      |
| `@nexasign/signing` | PDF signing (Local P12, Google Cloud KMS)                 |
| `@nexasign/ee`      | Enterprise Edition features                               |
| `@nexasign/assets`  | Static assets                                             |

### Supporting Packages

| Package                      | Description               |
| ---------------------------- | ------------------------- |
| `@nexasign/app-tests`       | E2E tests (Playwright)    |
| `@nexasign/eslint-config`   | Shared ESLint config      |
| `@nexasign/prettier-config` | Shared Prettier config    |
| `@nexasign/tailwind-config` | Shared Tailwind config    |
| `@nexasign/tsconfig`        | Shared TypeScript configs |
