...
description: Create and send a document for signing using the NexaFile API, from uploading a PDF to adding recipients and distributing for signature.
---
...
- A NexaFile account (cloud or self-hosted)
...
| ----------- | -------------------------------------- |
| Production  | `https://nexasign.nexastack.co/api/v2`     |
| Staging     | `https://stg-nexasign.nexastack.co/api/v2` |
...
```javascript
const response = await fetch('https://nexasign.nexastack.co/api/v2/envelope', {
  method: 'GET',
  headers: {
...
<Tab value="curl">
```bash
curl -X POST "https://nexasign.nexastack.co/api/v2/envelope/envelope_abc123/distribute" \
  -H "Authorization: YOUR_API_TOKEN" \
...
const response = await fetch(
  `https://nexasign.nexastack.co/api/v2/envelope/${envelopeId}/distribute`,
  {
    method: 'POST',
    headers: {
      Authorization: 'YOUR_API_TOKEN',
...
BASE_URL="https://nexasign.nexastack.co/api/v2"
...
- [API Reference](https://nexasign.nexastack.co/api/v2/openapi.json/) - Full endpoint documentation with request/response schemas
...
- [TypeScript SDK](https://github.com/nexasign/sdk-typescript)
- [Python SDK](https://github.com/nexasign/sdk-python)
- [Go SDK](https://github.com/nexasign/sdk-go)
