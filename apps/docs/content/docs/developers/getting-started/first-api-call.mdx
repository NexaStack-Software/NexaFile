...
description: Create and send a document for signing using the NexaSign API, from uploading a PDF to adding recipients and distributing for signature.
---
...
- A NexaSign account (cloud or self-hosted)
