...
- A NexaSign account on any plan (Free, Individual, Team, or Enterprise)
...
- Log in to your NexaSign account
...
NexaSign provides official SDKs that handle authentication for you:

```typescript
import { NexaSign } from '@nexasign/sdk-typescript';

const client = new NexaSign({
