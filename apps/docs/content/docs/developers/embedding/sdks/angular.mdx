---
title: Angular
description: Embed NexaSign signing in your Angular application using the official SDK.
---
...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab value="npm">``` npm install @nexasign/embed-angular ```</Tab>
  <Tab value="yarn">``` yarn add @nexasign/embed-angular ```</Tab>
  <Tab value="pnpm">``` pnpm add @nexasign/embed-angular ```</Tab>
</Tabs>
...
import { EmbedDirectTemplate } from '@nexasign/embed-angular';
...
import { EmbedSignDocument } from '@nexasign/embed-angular';
