---
title: Solid
description: Embed NexaFile signing in your Solid application using the official SDK.
---
...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab value="npm">``` npm install @nexasign/embed-solid ```</Tab>
  <Tab value="yarn">``` yarn add @nexasign/embed-solid ```</Tab>
  <Tab value="pnpm">``` pnpm add @nexasign/embed-solid ```</Tab>
</Tabs>
...
```tsx
import { EmbedDirectTemplate } from '@nexasign/embed-solid';
...
```tsx
import { EmbedSignDocument } from '@nexasign/embed-solid';
