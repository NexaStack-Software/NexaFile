---
title: Vue
description: Embed NexaFile signing in your Vue application using the official SDK.
---
...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab value="npm">``` npm install @nexasign/embed-vue ```</Tab>
  <Tab value="yarn">``` yarn add @nexasign/embed-vue ```</Tab>
  <Tab value="pnpm">``` pnpm add @nexasign/embed-vue ```</Tab>
</Tabs>
...
<script setup lang="ts">
  import { EmbedDirectTemplate } from '@nexasign/embed-vue';
...
```html
<script setup lang="ts">
  import { EmbedSignDocument } from '@nexasign/embed-vue';
