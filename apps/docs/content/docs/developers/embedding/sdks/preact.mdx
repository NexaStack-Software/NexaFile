---
title: Preact
description: Embed NexaSign signing in your Preact application using the official SDK.
---
...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab value="npm">``` npm install @nexasign/embed-preact ```</Tab>
  <Tab value="yarn">``` yarn add @nexasign/embed-preact ```</Tab>
  <Tab value="pnpm">``` pnpm add @nexasign/embed-preact ```</Tab>
</Tabs>
...
```tsx
import { EmbedDirectTemplate } from '@nexasign/embed-preact';
...
```tsx
import { EmbedSignDocument } from '@nexasign/embed-preact';
