---
title: React
description: Embed NexaFile signing in your React application using the official SDK.
---
...
<Tabs items={['npm', 'yarn', 'pnpm']}>
  <Tab value="npm">``` npm install @nexasign/embed-react ```</Tab>
  <Tab value="yarn">``` yarn add @nexasign/embed-react ```</Tab>
  <Tab value="pnpm">``` pnpm add @nexasign/embed-react ```</Tab>
</Tabs>
