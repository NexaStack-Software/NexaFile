...
NexaFile offers two types of embedding:
...
<Steps>
<Step>
Navigate to your team's templates in NexaFile
...
| `host`                | `string`   | NexaFile instance URL. Defaults to `https://nexasign.nexastack.co`. |
...
| `language`            | `string`   | Set the UI language. See [Supported Languages](https://github.com/NexaStack-Software/NexaFile/tree/main/packages/lib/constants/locales.ts). |
