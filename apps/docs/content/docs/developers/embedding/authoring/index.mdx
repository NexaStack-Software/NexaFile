...
In addition to embedding signing, NexaFile supports embedded authoring. It allows your users to create and edit documents, templates, and envelopes without leaving your application.
...
This endpoint requires your NexaFile API key. The token has a default expiration of 1 hour.
