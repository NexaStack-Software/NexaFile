...
In addition to embedding signing, NexaSign supports embedded authoring. It allows your users to create and edit documents, templates, and envelopes without leaving your application.
...
This endpoint requires your NexaSign API key. The token has a default expiration of 1 hour.

See the [API documentation](https://nexasign.nexastack.co/api/v2/openapi.json/reference#tag/embedding) for full details.
