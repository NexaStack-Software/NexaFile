...
<Callout type="warn">
  Embedded authoring is included with [Enterprise](https://nexastack.co) plans. It is
  also available as a paid add-on for the [Platform Plan](https://nexastack.co).
...
```jsx
import { EmbedCreateDocumentV1 } from '@nexasign/embed-react';
...
```jsx
import { EmbedCreateTemplateV1 } from '@nexasign/embed-react';
...
```jsx
import { EmbedUpdateDocumentV1 } from '@nexasign/embed-react';
...
```jsx
import { EmbedUpdateTemplateV1 } from '@nexasign/embed-react';
...
| `host`             | `string`  | No       | Custom host URL. Defaults to `https://nexasign.nexastack.co` |
...
| `language`         | `string`  | No       | Set the UI language. See [Supported Languages](https://github.com/NexaStack-Software/NexaFile/tree/main/packages/lib/constants/locales.ts) |
...
import { EmbedCreateDocumentV1, EmbedUpdateDocumentV1 } from '@nexasign/embed-react';
