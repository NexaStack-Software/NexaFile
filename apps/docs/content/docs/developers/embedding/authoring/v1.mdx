...
| `language`         | `string`  | No       | Set the UI language. See [Supported Languages](https://github.com/NexaStack-Software/NexaSign/tree/main/packages/lib/constants/locales.ts) |
