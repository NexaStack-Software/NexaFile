...
description: Use the demo environment to try out the NexaSign platform and its features.
---
...
You can use it to try out the NexaSign platform and its features before committing to a paid plan.
...
<Steps>
  <Step>
    ...
    Go to the [staging environment](https://stg-nexasign.nexastack.co).
  ...
  <Step>
    ...
    If you have any issues, questions or feedback, please reach out to us on the [NexaSign Discord](https://github.com/nexastack/nexasign/discussions) or [GitHub](https://github.com/nexastack/nexasign/issues).
