...
description: Advanced development tools for debugging field IDs, recipient IDs, coordinates and integrating with the NexaFile API.
---

## Overview

Developer mode provides additional tools and features to help you integrate and debug NexaFile.
...
https://nexasign.nexastack.co/t/<team-url>/documents/<envelope-id>/legacy_editor?devmode=true
```
...
https://nexasign.nexastack.co/t/<team-url>/documents/<envelope-id>/edit?step=addFields&devmode=true
```
