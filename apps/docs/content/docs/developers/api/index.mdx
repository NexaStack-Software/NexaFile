---
title: API Reference
description: Complete reference for the NexaFile REST API.
---
...
<Callout type="warn">
  ...
  For an always up-to-date reference, see the [OpenAPI Reference](https://nexasign.nexastack.co/api/v2/openapi.json).
</Callout>
