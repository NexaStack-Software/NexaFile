...
Search the existing [issues](https://github.com/NexaStack-Software/NexaSign/issues) to see if someone else reported the same issue. Or, check the [existing PRs](https://github.com/NexaStack-Software/NexaSign/pulls) to see if someone else is already working on the same thing.
...
Accept the [Contributor License Agreement](https://github.com/NexaStack-Software/NexaSign) to ensure we can accept your contributions.
...
<Callout type="info">
  If you need help getting started, [join us on Discord](https://github.com/NexaStack-Software/NexaSign/discussions).
</Callout>
