---
title: Contributing to NexaFile
description: Learn how to contribute to NexaFile and become part of our community.
---
...
If you plan to contribute to NexaFile, please take a moment to feel awesome. People like you are what open source is about. Any contributions, no matter how big or small, are highly appreciated.

This guide will help you get started with contributing to NexaFile.
...
Search the existing [issues](https://github.com/NexaStack-Software/NexaFile/issues) to see if someone else reported the same issue. Or, check the [existing PRs](https://github.com/NexaStack-Software/NexaFile/pulls) to see if someone else is already working on the same thing.
...
Accept the [Contributor License Agreement](https://github.com/NexaStack-Software/NexaFile) to ensure we can accept your contributions.
...
<Callout type="info">
  If you need help getting started, [join us on Discord](https://github.com/NexaStack-Software/NexaFile/discussions).
</Callout>
...
- [Contributing Translations](/docs/developers/contributing/contributing-translations) - Help translate NexaFile
