...
We store our translations in PO files, which are located in our GitHub repository [here](https://github.com/NexaStack-Software/NexaFile/tree/main/packages/lib/translations).
...
<Callout type="info">
  If you have any questions, hop into our [Discord](https://github.com/NexaStack-Software/NexaFile/discussions) and ask us directly!
</Callout>
