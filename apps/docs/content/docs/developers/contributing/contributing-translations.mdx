...
description: Learn how to contribute translations to NexaFile and become part of our community.
---
...
msgid "Want to send slick signing links like this one? <0>Check out NexaFile.</0>"
msgstr "Möchten Sie auffällige Signatur-Links wie diesen senden? <0>Überprüfen Sie NexaFile.</0>"
```
...
Thank you for helping make NexaFile more accessible to users around the world!
