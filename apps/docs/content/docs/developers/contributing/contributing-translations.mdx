...
We store our translations in PO files, which are located in our GitHub repository [here](https://github.com/nexastack/nexasign/tree/main/packages/lib/translations).
...
<Callout type="info">
  If you have any questions, hop into our [Discord](https://github.com/nexastack/nexasign/discussions) and ask us directly!
</Callout>
