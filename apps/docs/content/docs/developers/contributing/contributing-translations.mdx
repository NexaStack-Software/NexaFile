...
description: Learn how to contribute translations to NexaSign and become part of our community.
---
...
We store our translations in PO files, which are located in our GitHub repository [here](https://github.com/NexaStack-Software/NexaSign/tree/main/packages/lib/translations).
...
msgid "Want to send slick signing links like this one? <0>Check out NexaSign.</0>"
msgstr "Möchten Sie auffällige Signatur-Links wie diesen senden? <0>Überprüfen Sie NexaSign.</0>"
```
...
<Callout type="info">
  If you have any questions, hop into our [Discord](https://github.com/NexaStack-Software/NexaSign/discussions) and ask us directly!
</Callout>

Thank you for helping make NexaSign more accessible to users around the world!
