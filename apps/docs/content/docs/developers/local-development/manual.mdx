---
title: Manual Setup
description: Manually set up NexaFile on your machine for local development.
---
...
Follow these steps to set up NexaFile on your local machine:
...
Fork the [NexaFile repository](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks) to your GitHub account.
...
```bash
git clone https://github.com/<your-username>/nexafile
```
...
```bash
npm run prisma:seed -w @nexasign/prisma
```
...
Access the NexaFile application by visiting `http://localhost:3000` in your web browser.
