---
title: Manual Setup
description: Manually set up NexaSign on your machine for local development.
---
...
Follow these steps to set up NexaSign on your local machine:
...
Fork the [NexaSign repository](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks) to your GitHub account.
...
```bash
git clone https://github.com/<your-username>/nexasign
```
...
Access the NexaSign application by visiting `http://localhost:3000` in your web browser.
