...
Navigate to [nexasign.nexastack.co/signup](https://nexasign.nexastack.co/signup) to create a free account. To start with a paid plan, visit the [pricing page](https://nexastack.co) and select your plan.
...
Check your inbox for a verification email and click the confirmation link. The email is sent from `noreply@nexasign.com`.
