...
description: Upload documents to NexaFile to prepare them for signing. Covers supported formats, file size limits, and upload methods.
---
...
<Callout type="warn">
  NexaFile does not support password-protected or encrypted PDF files. Remove encryption before
  uploading.
</Callout>

## Upload Methods

![Documents dashboard](/document-signing/nexasign-documents-dashboard.webp)
...
<Steps>
  <Step>
    ...
    Open your [Documents dashboard](https://nexasign.nexastack.co/documents).
...
1. **Processing**: NexaFile validates the PDF and extracts page information
