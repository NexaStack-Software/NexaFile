...
<Callout type="warn">
  NexaSign does not support password-protected or encrypted PDF files. Remove encryption before
  uploading.
</Callout>
...
1. **Processing**: NexaSign validates the PDF and extracts page information
