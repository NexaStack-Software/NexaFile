...
- **Create one automatically**: NexaFile creates a new "Direct Link Recipient" for you
...
If the recipient has a NexaFile account with the email they entered, the document also appears in their Documents dashboard.
...
You can showcase templates with direct links on your public NexaFile profile:
...
![NexaFile profile with direct links](/direct-links/nexasign-profile.webp)
