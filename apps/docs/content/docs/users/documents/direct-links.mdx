...
- **Create one automatically**: NexaSign creates a new "Direct Link Recipient" for you

![Choose direct link recipient](/direct-links/choose-direct-link-recipient-nexasign.webp)
...
```
https://nexasign.nexastack.co/d/<unique-token>
```

![Document direct link](/direct-links/document-direct-link-nexasign.webp)
...
If the recipient has a NexaSign account with the email they entered, the document also appears in their Documents dashboard.
...
You can showcase templates with direct links on your public NexaSign profile:
...
![NexaSign profile with direct links](/direct-links/nexasign-profile.webp)
...
```html
<a href="https://nexasign.nexastack.co/d/your-token">Sign our agreement</a>
```
