---
title: Overview
description: Organisations are the top-level entity in NexaFile, containing teams, members, and shared settings.
---
...
Organisations are the top-level entity in NexaFile's hierarchy. Each organisation can contain multiple teams, and each team can have multiple members.
...
![Create organisation in NexaFile dashboard](/organisations/organisations-create.webp)
