---
title: Overview
description: Organisations are the top-level entity in NexaSign, containing teams, members, and shared settings.
---
...
Organisations are the top-level entity in NexaSign's hierarchy. Each organisation can contain multiple teams, and each team can have multiple members.
...
![Create organisation in NexaSign dashboard](/organisations/organisations-create.webp)
