---
title: Email Domains
description: Learn how to create and manage email domains in NexaFile.
---
...
Email Domains allow you to send emails to recipients from your own domain instead of the default NexaFile email address.
...
- Access to your NexaFile organisation as an admin or manager
...
After adding your domain, NexaFile will provide you with the following required DNS records that need to be configured on your domain:
...
Once you've added the DNS records, return to the NexaFile email domains settings page and click the "Verify" button.
