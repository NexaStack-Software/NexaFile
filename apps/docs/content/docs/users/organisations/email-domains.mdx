---
title: Email Domains
description: Learn how to create and manage email domains in NexaSign.
---
...
Email Domains allow you to send emails to recipients from your own domain instead of the default NexaSign email address.
...
- Access to your NexaSign organisation as an admin or manager
...
After adding your domain, NexaSign will provide you with the following required DNS records that need to be configured on your domain:
...
Once you've added the DNS records, return to the NexaSign email domains settings page and click the "Verify" button.
