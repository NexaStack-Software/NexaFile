---
title: GDPR
description: Understand how NexaFile handles GDPR compliance for data processing and storage.
---
...
When using NexaFile for document signing, two distinct data processing roles apply:

| Role                | Description                                                                           |
| ------------------- | ------------------------------------------------------------------------------------- |
| **Data Controller** | You (the organisation using NexaFile) determine the purposes and means of processing |
| **Data Processor**  | NexaFile processes personal data on your behalf according to your instructions       |
...
As the data processor, NexaFile:
...
NexaFile processes personal data necessary to provide document signing services:
...
Where your data is stored depends on how you use NexaFile:

<Tabs items={['NexaFile Cloud', 'Self-Hosted']}>
<Tab value="NexaFile Cloud">
...
Contact NexaFile for specific information about sub-processors and data centre locations.

</Tab>
<Tab value="Self-Hosted">

When you self-host NexaFile:

- You control all data storage locations
- No data is transmitted to NexaFile's infrastructure
...
- Export user and document data from your NexaFile account
- Delete user accounts and associated documents
- Contact NexaFile support for assistance with cloud-hosted data

## Data Deletion

NexaFile supports data deletion to help fulfill erasure requests:
...
Self-hosting NexaFile can simplify GDPR compliance:
...
- Contact [info@nexastack.co](mailto:info@nexastack.co) to request a DPA
- The DPA covers NexaFile's obligations as a data processor

</Tab>
<Tab value="Self-Hosted">

No DPA with NexaFile is required since no personal data is processed by NexaFile.
...
This documentation is provided for informational purposes only and does not constitute legal advice. GDPR compliance depends on your specific circumstances, including how you use NexaFile, what data you process, and your organisation's obligations.
...
- [Self-Hosting Guide](/docs/self-hosting) - Deploy NexaFile on your own infrastructure
