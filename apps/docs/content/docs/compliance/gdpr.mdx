---
title: GDPR
description: Understand how NexaSign handles GDPR compliance for data processing and storage.
---
...
When using NexaSign for document signing, two distinct data processing roles apply:

| Role                | Description                                                                           |
| ------------------- | ------------------------------------------------------------------------------------- |
| **Data Controller** | You (the organisation using NexaSign) determine the purposes and means of processing |
| **Data Processor**  | NexaSign processes personal data on your behalf according to your instructions       |
...
As the data processor, NexaSign:
...
NexaSign processes personal data necessary to provide document signing services:
...
Where your data is stored depends on how you use NexaSign:

<Tabs items={['NexaSign Cloud', 'Self-Hosted']}>
<Tab value="NexaSign Cloud">
...
Contact NexaSign for specific information about sub-processors and data centre locations.

</Tab>
<Tab value="Self-Hosted">

When you self-host NexaSign:

- You control all data storage locations
- No data is transmitted to NexaSign's infrastructure
...
- Export user and document data from your NexaSign account
- Delete user accounts and associated documents
- Contact NexaSign support for assistance with cloud-hosted data

## Data Deletion

NexaSign supports data deletion to help fulfill erasure requests:
...
Self-hosting NexaSign can simplify GDPR compliance:
...
- The DPA covers NexaSign's obligations as a data processor

</Tab>
<Tab value="Self-Hosted">

No DPA with NexaSign is required since no personal data is processed by NexaSign.
...
This documentation is provided for informational purposes only and does not constitute legal advice. GDPR compliance depends on your specific circumstances, including how you use NexaSign, what data you process, and your organisation's obligations.
...
- [Self-Hosting Guide](/docs/self-hosting) - Deploy NexaSign on your own infrastructure
