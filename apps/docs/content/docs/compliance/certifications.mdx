...
description: NexaFile's compliance status for industry certifications and regulatory frameworks.
---
...
Read more about [21 CFR Part 11 with NexaFile](https://nexastack.co).
...
<Callout type="info">Status: [Compliant](https://nexastack.co)</Callout>
...
<Callout type="warn">Status: [Planned](https://github.com/NexaStack-Software/NexaFile/issues/26)</Callout>
