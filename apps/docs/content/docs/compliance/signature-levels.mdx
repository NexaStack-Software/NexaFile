...
<Callout type="warn">
  Status: [Planned](https://github.com/nexasign/backlog/issues/9) via third party until [Let's
  Sign](https://github.com/nexasign/backlog/issues/21) is realized.
</Callout>
...
<Callout type="warn">
  Status: [Planned](https://github.com/nexasign/backlog/issues/32) via third party until [Let's
  Sign](https://github.com/nexasign/backlog/issues/21) is realized.
</Callout>
...
<Callout type="warn">Status: [Planned](https://github.com/nexasign/backlog/issues/34)</Callout>
