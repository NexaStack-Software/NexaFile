...
<Callout type="info">
  NexaFile seals all signed documents cryptographically, regardless of signature level, to prevent
...
<Callout type="warn">
  Status: [Planned](https://github.com/NexaStack-Software/NexaFile/issues/9) via third party until [Let's
  Sign](https://github.com/NexaStack-Software/NexaFile/issues/21) is realized.
</Callout>
...
<Callout type="warn">
  Status: [Planned](https://github.com/NexaStack-Software/NexaFile/issues/32) via third party until [Let's
  Sign](https://github.com/NexaStack-Software/NexaFile/issues/21) is realized.
</Callout>
...
## What NexaFile Provides

NexaFile supports Simple Electronic Signatures (SES) with features that enhance evidentiary value:
...
### What NexaFile Does Not Provide
...
<Callout type="warn">Status: [Planned](https://github.com/NexaStack-Software/NexaFile/issues/34)</Callout>
