...
<Callout type="info">
  NexaSign seals all signed documents cryptographically, regardless of signature level, to prevent
...
## What NexaSign Provides

NexaSign supports Simple Electronic Signatures (SES) with features that enhance evidentiary value:
...
### What NexaSign Does Not Provide
