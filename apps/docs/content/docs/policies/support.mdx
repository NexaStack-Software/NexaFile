...
Join the NexaSign Discord server to:

- Ask questions and get help from the community
- Share feedback and feature requests
- Connect with other NexaSign users
...
Paid plans include access to direct support from the NexaSign team.
...
- Technical guidance for NexaSign Cloud usage
...
- Private Discord channel for direct communication with the NexaSign team
...
- Guidance on NexaSign features and functionality
...
NexaSign follows responsible disclosure practices. Security researchers who report valid vulnerabilities responsibly will be acknowledged.
...
- [Privacy Policy](/docs/policies/privacy) - How NexaSign handles your data
