...
Join the NexaFile Discord server to:

- Ask questions and get help from the community
- Share feedback and feature requests
- Connect with other NexaFile users
...
- **[GitHub Discussions](https://github.com/NexaStack-Software/NexaSign/discussions)**: Ask questions, share ideas, and discuss features
- **[GitHub Issues](https://github.com/NexaStack-Software/NexaSign/issues)**: Report confirmed bugs with reproducible steps
...
Paid plans include access to direct support from the NexaFile team.
...
- Email support at info@nexastack.co
- Account and billing assistance
- Technical guidance for NexaFile Cloud usage
- Response during business hours

</Tab>
<Tab value="Platform and Above">

Available on [Platform plans](https://nexastack.co) and above:

- All standard support channels
- Private Discord channel for direct communication with the NexaFile team
...
Contact [sales](https://nexastack.co) for Enterprise support options.
...
- [GitHub Discussions](https://github.com/NexaStack-Software/NexaSign/discussions) - Community Q&A

<Callout type="info">
  Enterprise licenses for self-hosted deployments can include dedicated support. Contact
  [sales](https://nexastack.co) for details.
</Callout>
...
- Guidance on NexaFile features and functionality
...
<Callout type="info">
  ...
  available separately. Contact [sales](https://nexastack.co) for details.
</Callout>
...
For billing disputes or account issues, email info@nexastack.co with your account details.
...
NexaFile follows responsible disclosure practices. Security researchers who report valid vulnerabilities responsibly will be acknowledged.

## Contact

| Purpose          | Contact                                                        |
| ---------------- | -------------------------------------------------------------- |
| General support  | info@nexastack.co                                          |
| Security issues  | security@nexastack.co                                         |
| Enterprise sales | [info@nexastack.co](https://nexastack.co)           |
| Privacy requests | info@nexastack.co                                          |
| Community        | [Discord](https://github.com/NexaStack-Software/NexaSign/discussions)                          |
| Bug reports      | [GitHub Issues](https://github.com/NexaStack-Software/NexaSign/issues) |
...
- [Privacy Policy](/docs/policies/privacy) - How NexaFile handles your data
