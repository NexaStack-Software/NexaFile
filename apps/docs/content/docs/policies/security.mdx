---
title: Security
description: Security practices for NexaFile Cloud and self-hosted deployments, along with our vulnerability disclosure process.
---
...
<Accordions type="multiple">
  <Accordion title="Development Security">
    ...
    [github.com/NexaStack-Software/NexaFile](https://github.com/NexaStack-Software/NexaFile)
  </Accordion>
...
<Accordions type="multiple">
  <Accordion title="Encryption in Transit">
    All data transmitted to and from NexaFile is encrypted using TLS 1.2 or higher. This includes:
  ...
  <Accordion title="Application-Level Encryption">
    NexaFile encrypts sensitive data at the application level:
...
NexaFile operates a responsible disclosure process for security vulnerabilities.
...
- [GitHub releases](https://github.com/NexaStack-Software/NexaFile/releases)
- [GitHub security advisories](https://github.com/NexaStack-Software/NexaFile/security/advisories)
...
1. Watch the [GitHub repository](https://github.com/NexaStack-Software/NexaFile) for releases
...
When self-hosting NexaFile, you are responsible for the security of your deployment. The following recommendations apply:
...
- **GitHub**: [github.com/NexaStack-Software/NexaFile](https://github.com/NexaStack-Software/NexaFile)
