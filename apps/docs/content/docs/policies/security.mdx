---
title: Security
description: Security practices for NexaSign Cloud and self-hosted deployments, along with our vulnerability disclosure process.
---
...
<Accordions type="multiple">
  <Accordion title="Development Security">
    ...
    [github.com/NexaStack-Software/NexaSign](https://github.com/NexaStack-Software/NexaSign)
  </Accordion>
...
<Accordions type="multiple">
  <Accordion title="Encryption in Transit">
    All data transmitted to and from NexaSign is encrypted using TLS 1.2 or higher. This includes:
  ...
  <Accordion title="Application-Level Encryption">
    NexaSign encrypts sensitive data at the application level:
...
NexaSign operates a responsible disclosure process for security vulnerabilities.

<Accordions type="multiple">
  <Accordion title="Reporting a Vulnerability">
    If you discover a security vulnerability, please report it by emailing:

    **security@nexastack.co**
...
- [GitHub releases](https://github.com/NexaStack-Software/NexaSign/releases)
- [GitHub security advisories](https://github.com/NexaStack-Software/NexaSign/security/advisories)
...
1. Watch the [GitHub repository](https://github.com/NexaStack-Software/NexaSign) for releases
...
When self-hosting NexaSign, you are responsible for the security of your deployment. The following recommendations apply:
...
- **Security vulnerabilities**: security@nexastack.co
- **General questions**: info@nexastack.co
- **GitHub**: [github.com/NexaStack-Software/NexaSign](https://github.com/NexaStack-Software/NexaSign)
