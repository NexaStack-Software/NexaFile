...
The full license text is available in the [LICENSE file](https://github.com/nexastack/nexasign/blob/main/LICENSE) in the repository.
...
<Accordions type="multiple">
  ...
  <Accordion title="GitHub">
    - **[GitHub Discussions](https://github.com/nexastack/nexasign/discussions)**: For questions, ideas, and general discussion
    - **[GitHub Issues](https://github.com/nexastack/nexasign/issues)**: For confirmed bug reports with reproducible steps
  </Accordion>
...
<Accordions type="multiple">
  <Accordion title="Code Contributions">
    1. Fork the [NexaSign repository](https://github.com/nexastack/nexasign)
  ...
  <Accordion title="Contributor Guidelines">
    ...
    - The [CONTRIBUTING.md](https://github.com/nexastack/nexasign/blob/main/CONTRIBUTING.md) file in the repository
