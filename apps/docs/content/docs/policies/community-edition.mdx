...
The full license text is available in the [LICENSE file](https://github.com/NexaStack-Software/NexaFile/blob/main/LICENSE) in the repository.
...
<Accordions type="multiple">
  ...
  <Accordion title="GitHub">
    - **[GitHub Discussions](https://github.com/NexaStack-Software/NexaFile/discussions)**: For questions, ideas, and general discussion
    - **[GitHub Issues](https://github.com/NexaStack-Software/NexaFile/issues)**: For confirmed bug reports with reproducible steps
  </Accordion>
...
<Accordions type="multiple">
  <Accordion title="Code Contributions">
    1. Fork the [NexaFile repository](https://github.com/NexaStack-Software/NexaFile)
  ...
  <Accordion title="Contributor Guidelines">
    ...
    - The [CONTRIBUTING.md](https://github.com/NexaStack-Software/NexaFile/blob/main/CONTRIBUTING.md) file in the repository
