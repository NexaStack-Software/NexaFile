...
description: The open-source version of NexaFile, available under the AGPL-3.0 license. Includes core document signing functionality and can be self-hosted.
---
...
| Action             | Description                                                   |
| ------------------ | ------------------------------------------------------------- |
| **Use**            | Run NexaFile for any purpose, including commercial use       |
...
<Accordions type="multiple">
  <Accordion title="Source Code Disclosure">
    If you modify NexaFile and make it available over a network, you must:
    ...
    <Callout type="warn">
      ...
      NexaFile instance over a network (whether internal or external), you must provide them access to
      the source code.
    </Callout>
  ...
  <Accordion title="License Continuity">
    ...
    - Combined works that incorporate NexaFile code are subject to AGPL-3.0
...
The Community Edition includes the core NexaFile functionality:
...
<Accordions type="multiple">
  <Accordion title="Discord">
    The NexaFile Discord server is the primary community support channel. You can:
...
<Callout type="info">
  Community support is provided on a best-effort basis by volunteers and NexaFile team members. For
  guaranteed response times and dedicated support, consider the Enterprise Edition.
</Callout>

## Contributing Back

Contributions to NexaFile are welcome and appreciated. You can contribute in several ways:

<Accordions type="multiple">
  <Accordion title="Code Contributions">
    1. Fork the [NexaFile repository](https://github.com/NexaStack-Software/NexaSign)
