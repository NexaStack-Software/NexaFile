...
<Cards>
  ...
  <Card
    ...
    description="Terms governing your use of NexaFile."
...
The complete legal documents are available on the main NexaFile website:

- [Privacy Policy](https://nexastack.co)
- [Terms of Service](https://nexastack.co)
