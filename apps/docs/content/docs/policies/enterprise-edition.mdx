...
description: Commercial license that removes AGPL-3.0 source code disclosure requirements, allowing organisations to integrate NexaFile into proprietary products.
---
...
- **Build proprietary products**: Integrate NexaFile into commercial software without releasing source code
...
- **Need to keep modifications private**: Any changes to NexaFile source code that you don't want to disclose

<Callout type="info">
  If you run NexaFile without modifications, or your modifications are open source under AGPL-3.0,
...
| SaaS product using NexaFile API only        | Community Edition  |
| SaaS product with modified NexaFile code    | Enterprise Edition |
...
<Accordions type="multiple">
  <Accordion title="License Rights">
    ...
    - **Proprietary integration**: Embed NexaFile in closed-source products without licensing conflicts.
    - **Sublicensing options**: Distribute NexaFile as part of your product to your customers (terms vary by agreement).
  ...
  <Accordion title="License Setup">
    1. Acquire a license by contacting [sales](https://nexastack.co)
    2. Access your license key at [nexastack.co](https://nexastack.co)
    3. Set the environment variable:

    ```bash
    NEXT_PRIVATE_NEXASIGN_LICENSE_KEY="your-license-key-here"
    ```

    4. Restart your NexaFile instance
...
<Accordions type="multiple">
  <Accordion title="Grant of License">
    The Enterprise license is a commercial agreement between your organisation and NexaFile. Key terms include:

    - **Scope**: License to use, modify, and distribute NexaFile as specified in your agreement
    - **Exclusions**: The license does not grant rights to NexaFile trademarks beyond what's specified
  ...
  <Accordion title="What the License Does Not Cover">
    ...
    - NexaFile Cloud service (separate subscription)
...
| Factor              | Description                         |
| ------------------- | ----------------------------------- |
| **Deployment type** | Self-hosted or NexaFile Cloud      |
...
Contact [sales](https://nexastack.co) for current pricing. Enterprise agreements typically include:
...
<Steps>
  ...
  <Step>
    ...
    - Email: [info@nexastack.co](https://nexastack.co)
  ...
  <Step>
    ...
    Options for evaluating NexaFile before purchase:
  ...
  <Step>
    ...
    3. Deploy using [self-hosting guides](/docs/self-hosting) or access NexaFile Cloud
...
<Accordions type="multiple">
  ...
  <Accordion title="Does the Enterprise license include NexaFile Cloud?">
  ...
  <Accordion title="Is there a trial period?">
    Contact [sales](https://nexastack.co) to discuss evaluation options for your
    organisation.
  </Accordion>
</Accordions>
