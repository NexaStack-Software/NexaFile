...
description: Commercial license that removes AGPL-3.0 source code disclosure requirements, allowing organisations to integrate NexaSign into proprietary products.
---
...
- **Build proprietary products**: Integrate NexaSign into commercial software without releasing source code
...
- **Need to keep modifications private**: Any changes to NexaSign source code that you don't want to disclose

<Callout type="info">
  If you run NexaSign without modifications, or your modifications are open source under AGPL-3.0,
...
| SaaS product using NexaSign API only        | Community Edition  |
| SaaS product with modified NexaSign code    | Enterprise Edition |
...
<Accordions type="multiple">
  <Accordion title="License Rights">
    ...
    - **Proprietary integration**: Embed NexaSign in closed-source products without licensing conflicts.
    - **Sublicensing options**: Distribute NexaSign as part of your product to your customers (terms vary by agreement).
  ...
  <Accordion title="License Setup">
    ...
    4. Restart your NexaSign instance
...
<Accordions type="multiple">
  <Accordion title="Grant of License">
    The Enterprise license is a commercial agreement between your organisation and NexaSign. Key terms include:

    - **Scope**: License to use, modify, and distribute NexaSign as specified in your agreement
    - **Exclusions**: The license does not grant rights to NexaSign trademarks beyond what's specified
  ...
  <Accordion title="What the License Does Not Cover">
    ...
    - NexaSign Cloud service (separate subscription)
...
| Factor              | Description                         |
| ------------------- | ----------------------------------- |
| **Deployment type** | Self-hosted or NexaSign Cloud      |
...
<Steps>
  ...
  <Step>
    ...
    Options for evaluating NexaSign before purchase:
  ...
  <Step>
    ...
    3. Deploy using [self-hosting guides](/docs/self-hosting) or access NexaSign Cloud
...
<Accordions type="multiple">
  ...
  <Accordion title="Does the Enterprise license include NexaSign Cloud?">
