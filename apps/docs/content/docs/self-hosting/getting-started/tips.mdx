...
docker pull nexastack/nexafile:1.8.0

# Risky — may pull breaking changes
docker pull nexastack/nexafile:latest
```

Check the [GitHub releases](https://github.com/NexaStack-Software/NexaFile/releases) page for available versions.
