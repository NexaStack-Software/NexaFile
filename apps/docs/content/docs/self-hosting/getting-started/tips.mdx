...
docker pull nexastack/nexasign:1.8.0

# Risky — may pull breaking changes
docker pull nexastack/nexasign:latest
```

Check the [GitHub releases](https://github.com/nexastack/nexasign/releases) page for available versions.
