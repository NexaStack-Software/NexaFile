...
description: Diagnose and resolve common issues with your self-hosted NexaSign instance, organized by component.
---
...
NexaSign exposes a health endpoint to verify the application is running:
...
<Steps>
  ...
  <Step>
    Change NexaSign's port mapping: `-p 3001:3000`
  </Step>
</Steps>
...
```
  ...
  <Step>
    Update the certificate file and restart NexaSign
  </Step>
</Steps>
...
- **[Discord](https://github.com/NexaStack-Software/NexaSign/discussions)**: Join the NexaSign community Discord
