---
title: Backups
description: Backup strategies for NexaSign data.
---
...
NexaSign stores data in three locations:
...
Create a script to back up all NexaSign components:
...
echo "Starting NexaSign backup: $TIMESTAMP"
...
```ini
[Unit]
Description=Daily NexaSign Backup
