---
title: Upgrades
description: Upgrade your self-hosted NexaSign installation to get the latest features, security patches, and bug fixes.
---
...
NexaSign follows [Semantic Versioning](https://semver.org/):
...
Check your running NexaSign version:
...
NexaSign runs database migrations automatically when the container starts. No manual intervention is required.
