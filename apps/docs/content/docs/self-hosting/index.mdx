---
title: Self-Hosting
description: Deploy and manage your own NexaFile instance for complete control over your data, compliance, and customization.
---
...
Get NexaFile running locally in under 5 minutes:
...
Self-hosted NexaFile includes full core functionality under the AGPL-3.0 license. If you need enterprise features such as SSO, embed authoring white label, or 21 CFR Part 11 compliance, you can activate them with a license key.
...
<Cards>
  <Card
    title="User Guide"
    description="Learn how to use NexaFile for document signing."
    href="/docs/users"
  />
  <Card
    title="Developer Guide"
    description="Integrate NexaFile into your applications using the API."
