...
description: Deploy NexaFile with Docker Compose, including PostgreSQL. This production-ready setup is suitable for most self-hosted deployments.
---
...
curl -O https://raw.githubusercontent.com/NexaStack-Software/NexaSign/release/docker/production/compose.yml
```
...
The NexaFile container waits for the database health check to pass before starting.
...
# Public URL where NexaFile is accessible
...
For production, place NexaFile behind a reverse proxy for SSL termination:
