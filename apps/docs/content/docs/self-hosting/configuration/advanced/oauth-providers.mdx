...
description: Learn how to set up OAuth providers for your own instance of NexaFile.
---
...
- **Authorized JavaScript origins**: `https://<nexasign-domain>`
- **Authorized redirect URIs**: `https://<nexasign-domain>/api/auth/callback/google`

</Step>
<Step>
### Set environment variables

In your NexaFile environment, set:
...
```bash
https://<nexasign-domain>/api/auth/callback/microsoft
```
