...
Create a service account with the `cloudkms.signerVerifier` role so NexaSign can use the key.

</Step>
<Step>
### Export public certificate

Export the public certificate from the HSM key; NexaSign needs it to embed in signatures.
