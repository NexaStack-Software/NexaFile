  ...
  return (
    <main className="mx-auto flex max-w-xl flex-col items-center justify-center px-4 py-32 text-center">
      ...
      <div className="mt-8 flex flex-wrap justify-center gap-3">
        <Link
          href="/docs/users"
          className="bg-nexasign text-fd-primary-foreground hover:bg-nexasign/90 inline-flex items-center rounded-lg px-5 py-2.5 text-sm font-medium transition-colors"
        >
