    ...
    <main className="mx-auto max-w-4xl px-4 py-12">
      ...
      <div className="mb-16 pt-6 text-center">
        ...
        <div className="flex flex-wrap justify-center gap-3">
          <Link
            href="/docs/users"
            className="bg-nexasign text-fd-primary-foreground hover:bg-nexasign-dark/90 inline-flex items-center gap-2 rounded-lg px-5 py-2.5 text-sm font-medium transition-colors"
          >
            Get Started
          </Link>
          <a
