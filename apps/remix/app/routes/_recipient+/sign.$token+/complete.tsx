...
import { isRecipientAuthorized } from '@nexasign/lib/server-only/document/is-recipient-authorized';
...
import { DocumentShareButton } from '@nexasign/ui/components/document/document-share-button';
        ...
        >
          ...
          {match({ status: signingStatus, deletedAt: document.deletedAt })
            .with({ status: 'COMPLETED' }, () => (
              <div className="mt-4 flex items-center text-center text-primary">
