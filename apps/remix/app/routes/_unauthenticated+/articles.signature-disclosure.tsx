  ...
  return (
    <div>
      <article className="prose dark:prose-invert">
        ...
        <p>
          <Trans>
            Thank you for using NexaFile to perform your electronic document signing. The purpose of
        ...
        <p>
          <Trans>
            By proceeding to use the electronic signature service provided by NexaFile, you affirm
