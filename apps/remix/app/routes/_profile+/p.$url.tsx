...
import { getPublicProfileByUrl } from '@nexasign/lib/server-only/profile/get-public-profile-by-url';
          ...
          <p className="max-w-[60ch] whitespace-pre-wrap break-words text-center text-sm leading-relaxed text-muted-foreground">
            ...
            {!user?.id && (
              <span className="mt-2 inline-block">
                <Trans>
                  While waiting for them to do so you can create your own NexaFile account and get
