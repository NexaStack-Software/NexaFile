...
import { generateEmailDomainRecords } from '@nexasign/lib/utils/email-domains';
import { trpc } from '@nexasign/trpc/react';
import type { TGetOrganisationEmailDomainResponse } from '@nexasign/trpc/server/enterprise-router/get-organisation-email-domain.types';
