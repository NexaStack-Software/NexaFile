...
import { getEditorEnvelopeById } from '@nexasign/lib/server-only/envelope/get-editor-envelope-by-id';
...
} from '@nexasign/lib/utils/embed-config';
import { prisma } from '@nexasign/prisma';
import { trpc } from '@nexasign/trpc/react';
import type { TUpdateEmbeddingEnvelopePayload } from '@nexasign/trpc/server/embedding-router/update-embedding-envelope.types';
