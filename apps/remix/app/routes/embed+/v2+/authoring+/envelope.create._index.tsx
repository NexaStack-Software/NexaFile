...
import { EnvelopeEditorProvider } from '@nexasign/lib/client-only/providers/envelope-editor-provider';
import type { SupportedLanguageCodes } from '@nexasign/lib/constants/i18n';
...
} from '@nexasign/lib/types/envelope-editor';
import type { TEnvelopeFieldAndMeta } from '@nexasign/lib/types/field-meta';
import { extractDerivedDocumentMeta } from '@nexasign/lib/utils/document';
import { buildEmbeddedFeatures } from '@nexasign/lib/utils/embed-config';
import { buildEmbeddedEditorOptions } from '@nexasign/lib/utils/embed-config';
import { prisma } from '@nexasign/prisma';
import { trpc } from '@nexasign/trpc/react';
import type { TCreateEnvelopePayload } from '@nexasign/trpc/server/envelope-router/create-envelope.types';
