...
import { getEnvelopeForDirectTemplateSigning } from '@nexasign/lib/server-only/envelope/get-envelope-for-direct-template-signing';
...
import { getTemplateByDirectLinkToken } from '@nexasign/lib/server-only/template/get-template-by-direct-link-token';
