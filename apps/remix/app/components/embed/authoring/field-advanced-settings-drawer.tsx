...
import { type TFieldMetaSchema as FieldMeta } from '@nexasign/lib/types/field-meta';
import { parseMessageDescriptor } from '@nexasign/lib/utils/i18n';
import { FieldAdvancedSettings } from '@nexasign/ui/primitives/document-flow/field-item-advanced-settings';
import { FRIENDLY_FIELD_TYPE } from '@nexasign/ui/primitives/document-flow/types';
import { Sheet, SheetContent, SheetTitle } from '@nexasign/ui/primitives/sheet';
