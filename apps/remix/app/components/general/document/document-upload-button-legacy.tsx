...
import { formatDocumentsPath, formatTemplatesPath } from '@nexasign/lib/utils/teams';
import { trpc } from '@nexasign/trpc/react';
import type { TCreateDocumentPayloadSchema } from '@nexasign/trpc/server/document-router/create-document.types';
import type { TCreateTemplatePayloadSchema } from '@nexasign/trpc/server/template-router/schema';
...
import { DocumentUploadButton as DocumentUploadButtonPrimitive } from '@nexasign/ui/primitives/document-upload-button';
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
  TooltipTrigger,
} from '@nexasign/ui/primitives/tooltip';
