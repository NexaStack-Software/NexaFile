...
import { useAnalytics } from '@nexasign/lib/client-only/hooks/use-analytics';
import { DEFAULT_DOCUMENT_DATE_FORMAT } from '@nexasign/lib/constants/date-formats';
import { PDF_VIEWER_PAGE_SELECTOR } from '@nexasign/lib/constants/pdf-viewer';
import { DEFAULT_DOCUMENT_TIME_ZONE } from '@nexasign/lib/constants/time-zones';
import type { DocumentAndSender } from '@nexasign/lib/server-only/document/get-document-by-token';
import type { TRecipientAccessAuth } from '@nexasign/lib/types/document-auth';
import {
  ZCheckboxFieldMeta,
  ZDropdownFieldMeta,
  ZNumberFieldMeta,
...
import type { CompletedField } from '@nexasign/lib/types/fields';
...
import { validateFieldsInserted } from '@nexasign/lib/utils/fields';
import type { FieldWithSignatureAndFieldMeta } from '@nexasign/prisma/types/field-with-signature-and-fieldmeta';
import type { RecipientWithFields } from '@nexasign/prisma/types/recipient-with-fields';
import { trpc } from '@nexasign/trpc/react';
import { DocumentReadOnlyFields } from '@nexasign/ui/components/document/document-read-only-fields';
import { Button } from '@nexasign/ui/primitives/button';
import { Card, CardContent } from '@nexasign/ui/primitives/card';
import { ElementVisible } from '@nexasign/ui/primitives/element-visible';
