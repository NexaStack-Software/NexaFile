...
import { useEnvelopeAutosave } from '@nexasign/lib/client-only/hooks/use-envelope-autosave';
...
import { APP_DOCUMENT_UPLOAD_SIZE_LIMIT } from '@nexasign/lib/constants/app';
import type { TEditorEnvelope } from '@nexasign/lib/types/envelope-editor';
import { nanoid } from '@nexasign/lib/universal/id';
import { megabytesToBytes } from '@nexasign/lib/universal/unit-convertions';
...
import type { TCreateEnvelopeItemsPayload } from '@nexasign/trpc/server/envelope-router/create-envelope-items.types';
import type { TReplaceEnvelopeItemPdfPayload } from '@nexasign/trpc/server/envelope-router/replace-envelope-item-pdf.types';
import { buildDropzoneRejectionDescription } from '@nexasign/ui/lib/handle-dropzone-rejection';
...
import { DocumentDropzone } from '@nexasign/ui/primitives/document-dropzone';
