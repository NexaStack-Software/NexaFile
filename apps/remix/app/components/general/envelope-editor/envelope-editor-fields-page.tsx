...
import { useCurrentEnvelopeRender } from '@nexasign/lib/client-only/providers/envelope-render-provider';
import { PDF_VIEWER_ERROR_MESSAGES } from '@nexasign/lib/constants/pdf-viewer-i18n';
import type { NormalizedFieldWithContext } from '@nexasign/lib/server-only/ai/envelope/detect-fields/types';
import {
...
import { canRecipientFieldsBeModified } from '@nexasign/lib/utils/recipients';
...
import { Separator } from '@nexasign/ui/primitives/separator';
