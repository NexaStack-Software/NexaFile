...
} from '@nexasign/lib/constants/document';
...
import {
  ...
  isValidLanguageCode,
} from '@nexasign/lib/constants/i18n';
...
} from '@nexasign/lib/types/document-auth';
...
import { isValidRedirectUrl } from '@nexasign/lib/utils/is-valid-redirect-url';
import {
  DocumentSignatureType,
  canAccessTeamDocument,
  extractTeamSignatureSettings,
} from '@nexasign/lib/utils/teams';
import { zEmail } from '@nexasign/lib/utils/zod';
import { trpc } from '@nexasign/trpc/react';
import { DocumentEmailCheckboxes } from '@nexasign/ui/components/document/document-email-checkboxes';
import {
  DocumentGlobalAuthAccessSelect,
  DocumentGlobalAuthAccessTooltip,
} from '@nexasign/ui/components/document/document-global-auth-access-select';
import {
  DocumentGlobalAuthActionSelect,
  DocumentGlobalAuthActionTooltip,
} from '@nexasign/ui/components/document/document-global-auth-action-select';
import { DocumentSendEmailMessageHelper } from '@nexasign/ui/components/document/document-send-email-message-helper';
import { DocumentSignatureSettingsTooltip } from '@nexasign/ui/components/document/document-signature-settings-tooltip';
import {
  DocumentVisibilitySelect,
  DocumentVisibilityTooltip,
} from '@nexasign/ui/components/document/document-visibility-select';
import { ExpirationPeriodPicker } from '@nexasign/ui/components/document/expiration-period-picker';
import { ReminderSettingsPicker } from '@nexasign/ui/components/document/reminder-settings-picker';
import {
  TemplateTypeSelect,
  TemplateTypeTooltip,
} from '@nexasign/ui/components/template/template-type-select';
import { cn } from '@nexasign/ui/lib/utils';
import { Button } from '@nexasign/ui/primitives/button';
import { CardDescription, CardHeader, CardTitle } from '@nexasign/ui/primitives/card';
import { Combobox } from '@nexasign/ui/primitives/combobox';
import {
  Dialog,
  DialogClose,
  DialogContent,
...
import {
  ...
  FormLabel,
  FormMessage,
} from '@nexasign/ui/primitives/form/form';
import { Input } from '@nexasign/ui/primitives/input';
import { MultiSelectCombobox } from '@nexasign/ui/primitives/multi-select-combobox';
import {
  Select,
  SelectContent,
  SelectItem,
...
import { Textarea } from '@nexasign/ui/primitives/textarea';
