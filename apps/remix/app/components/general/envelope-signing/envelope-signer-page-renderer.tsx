...
import { usePageRenderer } from '@nexasign/lib/client-only/hooks/use-page-renderer';
import {
  type PageRenderData,
  useCurrentEnvelopeRender,
} from '@nexasign/lib/client-only/providers/envelope-render-provider';
import { useOptionalSession } from '@nexasign/lib/client-only/providers/session';
import { DIRECT_TEMPLATE_RECIPIENT_EMAIL } from '@nexasign/lib/constants/direct-templates';
import { isBase64Image } from '@nexasign/lib/constants/signatures';
import type { TRecipientActionAuth } from '@nexasign/lib/types/document-auth';
import type { TEnvelope } from '@nexasign/lib/types/envelope';
import { ZFullFieldSchema } from '@nexasign/lib/types/field';
import { createSpinner } from '@nexasign/lib/universal/field-renderer/field-generic-items';
import { renderField } from '@nexasign/lib/universal/field-renderer/render-field';
import { isFieldUnsignedAndRequired } from '@nexasign/lib/utils/advanced-fields-helpers';
import { getClientSideFieldTranslations } from '@nexasign/lib/utils/fields';
import { extractInitials } from '@nexasign/lib/utils/recipient-formatter';
import type { TSignEnvelopeFieldValue } from '@nexasign/trpc/server/envelope-router/sign-envelope-field.types';
import { EnvelopeRecipientFieldTooltip } from '@nexasign/ui/components/document/envelope-recipient-field-tooltip';
import { EnvelopeFieldToolTip } from '@nexasign/ui/components/field/envelope-field-tooltip';
