...
import { useOptionalCurrentOrganisation } from '@nexasign/lib/client-only/providers/organisation';
import { useSession } from '@nexasign/lib/client-only/providers/session';
import { EXTENDED_ORGANISATION_MEMBER_ROLE_MAP } from '@nexasign/lib/constants/organisations-translations';
import { EXTENDED_TEAM_MEMBER_ROLE_MAP } from '@nexasign/lib/constants/teams-translations';
import { formatAvatarUrl } from '@nexasign/lib/utils/avatars';
import { isAdmin } from '@nexasign/lib/utils/is-admin';
import { canExecuteOrganisationAction } from '@nexasign/lib/utils/organisations';
import { extractInitials } from '@nexasign/lib/utils/recipient-formatter';
import { canExecuteTeamAction } from '@nexasign/lib/utils/teams';
import { AnimateGenericFadeInOut } from '@nexasign/ui/components/animate/animate-generic-fade-in-out';
import { LanguageSwitcherDialog } from '@nexasign/ui/components/common/language-switcher-dialog';
