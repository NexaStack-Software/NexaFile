...
import { downloadFile } from '@nexasign/lib/client-only/download-file';
import { useCurrentOrganisation } from '@nexasign/lib/client-only/providers/organisation';
import { IS_BILLING_ENABLED, SUPPORT_EMAIL } from '@nexasign/lib/constants/app';
import { ORGANISATION_MEMBER_ROLE_HIERARCHY } from '@nexasign/lib/constants/organisations';
import { ORGANISATION_MEMBER_ROLE_MAP } from '@nexasign/lib/constants/organisations-translations';
import { INTERNAL_CLAIM_ID } from '@nexasign/lib/types/subscription';
import { zEmail } from '@nexasign/lib/utils/zod';
import { trpc } from '@nexasign/trpc/react';
import { ZCreateOrganisationMemberInvitesRequestSchema } from '@nexasign/trpc/server/organisation-router/create-organisation-member-invites.types';
import { cn } from '@nexasign/ui/lib/utils';
import { Alert, AlertDescription } from '@nexasign/ui/primitives/alert';
...
import { SpinnerBox } from '@nexasign/ui/primitives/spinner';
import { Tabs, TabsContent, TabsList, TabsTrigger } from '@nexasign/ui/primitives/tabs';
...
export const OrganisationMemberInviteDialog = ({
  ...
  const downloadTemplate = () => {
    const data = [
      { email: 'admin@beispiel.de', role: 'Admin' },
      { email: 'manager@beispiel.de', role: 'Manager' },
      { email: 'member@beispiel.de', role: 'Member' },
    ];
    ...
    downloadFile({
      filename: 'nexasign-organisation-member-invites-template.csv',
      data: blob,
    });
  };
