...
} from '@nexasign/lib/constants/direct-templates';
import { incrementTemplateId } from '@nexasign/lib/server-only/envelope/increment-id';
...
export const seedTemplate = async (options: SeedTemplateOptions) => {
  ...
  return await prisma.envelope.create({
    data: {
      ...
      recipients: {
        create: {
          email: 'recipient.1@nexasign.com',
          name: 'Recipient 1',
