...
import { hashSync } from '@nexasign/lib/server-only/auth/hash';
import { createPersonalOrganisation } from '@nexasign/lib/server-only/organisation/create-organisation';
...
export const seedTestEmail = () => `${nanoid()}@test.nexasign.com`;
...
export const seedUser = async ({
  ...
  if (!email) {
    email = `${nanoid()}@test.nexasign.com`;
  }
