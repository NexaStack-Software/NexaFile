...
import { createDocumentAuthOptions } from '@nexasign/lib/utils/document-auth';
...
import { seedDirectTemplate, seedTemplate } from '@nexasign/prisma/seed/templates';
import { seedTestEmail, seedUser } from '@nexasign/prisma/seed/users';
...
test('[DIRECT_TEMPLATES]: use direct template link with 1 recipient', async ({ page }) => {
  ...
  await page.getByPlaceholder('recipient@nexasign.com').fill(seedTestEmail());
