...
import { createTeam } from '@nexasign/lib/server-only/team/create-team';
import { nanoid } from '@nexasign/lib/universal/id';
import { seedOrganisationMembers } from '@nexasign/prisma/seed/organisations';
...
test('[ORGANISATIONS]: inherit members', async ({ page }) => {
  ...
  const memberEmail = `member-${nanoid()}@test.nexasign.com`;
  const memberEmail2 = `member-2-${nanoid()}@test.nexasign.com`;
  const memberEmail3 = `member-3-${nanoid()}@test.nexasign.com`;
  const managerEmail = `manager-${nanoid()}@test.nexasign.com`;
  const adminEmail = `admin-${nanoid()}@test.nexasign.com`;
...
test('[ORGANISATIONS]: manage groups and members', async ({ page }) => {
  ...
  const memberEmail1 = `member-1-${nanoid()}@test.nexasign.com`;
  const memberEmail2 = `member-2-${nanoid()}@test.nexasign.com`;
  const memberEmail3 = `member-3-${nanoid()}@test.nexasign.com`;
  const memberEmail4 = `member-4-${nanoid()}@test.nexasign.com`;
  const memberEmail5 = `member-5-${nanoid()}@test.nexasign.com`;
  const memberEmail6 = `member-6-${nanoid()}@test.nexasign.com`;

  const adminEmail1 = `admin-1-${nanoid()}@test.nexasign.com`;
  const adminEmail2 = `admin-2-${nanoid()}@test.nexasign.com`;
  const adminEmail3 = `admin-3-${nanoid()}@test.nexasign.com`;
