...
import { getBoundingClientRect } from '@nexasign/lib/client-only/get-bounding-client-rect';
import { useAutoSave } from '@nexasign/lib/client-only/hooks/use-autosave';
import { useDocumentElement } from '@nexasign/lib/client-only/hooks/use-document-element';
import { PDF_VIEWER_PAGE_SELECTOR, getPdfPagesCount } from '@nexasign/lib/constants/pdf-viewer';
import { RECIPIENT_ROLES_DESCRIPTION } from '@nexasign/lib/constants/recipient-roles';
import { isTemplateRecipientEmailPlaceholder } from '@nexasign/lib/constants/template';
import {
...
import { ADVANCED_FIELD_TYPES_WITH_OPTIONAL_SETTING } from '@nexasign/lib/utils/advanced-fields-helpers';
import { parseMessageDescriptor } from '@nexasign/lib/utils/i18n';
...
import {
  ...
  CommandInput,
  CommandItem,
} from '@nexasign/ui/primitives/command';
import {
...
} from '@nexasign/ui/primitives/document-flow/document-flow-root';
import { FieldItem } from '@nexasign/ui/primitives/document-flow/field-item';
import type { DocumentFlowStep } from '@nexasign/ui/primitives/document-flow/types';
import { FRIENDLY_FIELD_TYPE } from '@nexasign/ui/primitives/document-flow/types';
import { Popover, PopoverContent, PopoverTrigger } from '@nexasign/ui/primitives/popover';
