...
import { sendOrganisationAccountLinkConfirmationEmail } from '@nexasign/ee/server-only/lib/send-organisation-account-link-confirmation-email';
import { AppError } from '@nexasign/lib/errors/app-error';
import { onCreateUserHook } from '@nexasign/lib/server-only/user/create-user';
import { formatOrganisationLoginUrl } from '@nexasign/lib/utils/organisation-authentication-portal';
