...
import { formatTeamUrl } from '@nexasign/lib/utils/teams';
...
export const ConfirmTeamEmailTemplate = ({
  ...
  baseUrl = 'https://nexasign.nexastack.co',
  teamName = 'Team Name',
  teamUrl = 'demo',
  token = '',
  ...
  const previewText = msg`Accept team email request for ${teamName} on NexaFile`;
            ...
            <Section className="p-2 text-slate-500">
              ...
              <Text className="text-center text-base">
                <Trans>
                  ...
                  address for their team on NexaFile.
                </Trans>
              </Text>
              ...
              <Section className="mt-6">
                ...
                <Text className="mt-2 text-sm">
                  <Trans>
                    You can revoke access at any time in your team settings on NexaFile{' '}
              ...
              <Section className="mb-6 mt-8 text-center">
                <Button
                  className="inline-flex items-center justify-center rounded-lg bg-primary px-6 py-3 text-center text-sm font-medium text-black no-underline"
