...
import RecipientRemovedFromDocumentTemplate from '@nexasign/email/templates/recipient-removed-from-document';
import { DOCUMENT_AUDIT_LOG_TYPE } from '@nexasign/lib/types/document-audit-logs';
import type { TRecipientAccessAuthTypes } from '@nexasign/lib/types/document-auth';
import {
...
import { createRecipientAuthOptions } from '@nexasign/lib/utils/document-auth';
