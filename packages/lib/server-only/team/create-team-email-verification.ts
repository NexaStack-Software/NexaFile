...
import { ConfirmTeamEmailTemplate } from '@nexasign/email/templates/confirm-team-email';
...
import { createTokenVerification } from '@nexasign/lib/utils/token-verification';
