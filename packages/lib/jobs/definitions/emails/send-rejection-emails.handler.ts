...
import DocumentRejectedEmail from '@nexasign/email/templates/document-rejected';
import DocumentRejectionConfirmedEmail from '@nexasign/email/templates/document-rejection-confirmed';
import { isRecipientEmailValidForSending } from '@nexasign/lib/utils/recipients';
import { prisma } from '@nexasign/prisma';

import { getI18nInstance } from '../../../client-only/providers/i18n-server';
import { NEXT_PUBLIC_WEBAPP_URL } from '../../../constants/app';
import { NEXASIGN_INTERNAL_EMAIL } from '../../../constants/email';
...
export const run = async ({
  ...
  await io.runTask('send-owner-notification-email', async () => {
    ...
    await mailer.sendMail({
      ...
      from: NEXASIGN_INTERNAL_EMAIL, // Purposefully using internal email here.
