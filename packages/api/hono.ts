...
import { ApiContractV1 } from '@nexasign/api/v1/contract';
import { ApiContractV1Implementation } from '@nexasign/api/v1/implementation';
import { OpenAPIV1 } from '@nexasign/api/v1/openapi';
import { testCredentialsHandler } from '@nexasign/lib/server-only/public-api/test-credentials';
import { listDocumentsHandler } from '@nexasign/lib/server-only/webhooks/zapier/list-documents';
import { subscribeHandler } from '@nexasign/lib/server-only/webhooks/zapier/subscribe';
import { unsubscribeHandler } from '@nexasign/lib/server-only/webhooks/zapier/unsubscribe';
// This is a bit nasty. Todo: Extract
import type { HonoEnv } from '@nexasign/remix/server/router';
...
tsRestHonoApp
  .get('/openapi', (c) => c.redirect('https://openapi-v1.nexasign.com'))
